...
// BU SORUNLU PAGE UI TEKRARI VAR SONRA BÖL
//(recipe detail ile aynı sadece db den çekiyor)
//hatta ileride aynı sayfaya taşımak daha mantıklı olabilir ??????

class FavoriteRecipeDetailPage extends StatelessWidget {
  final Meal meal;

  const FavoriteRecipeDetailPage({super.key, required this.meal});
